           ...
           <div className={classes.textArea}>
            <div className={classes.text}>
               ...
               <Typewriter
                ...
                options={{
                strings: ['outrank the competition.', 'look sexy online.','create badass content.','generate more leads.'],
                autoStart: true,
                loop: true,
              }}
               />
                ...
                <div className={classes.action}>
                    ...
                    <div onMouseEnter={()=>animateLeft()} onMouseLeave={()=>stop()} className={classes.work}>How we work <i ref={f1} className='fas fa-arrow-right'></i> </div>
                </ div>
           </div>
